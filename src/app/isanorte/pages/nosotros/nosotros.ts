...
// Shared Components
import { RevealStagger } from '../../../shared/animaciones/reveal-stagger/reveal-stagger';
// Interfaces (contrato de datos; las reutilizará también el formulario del admin)
export interface NosotrosHeroMetaItem { label: string; value: string; }
...
export interface NosotrosStat { value: string; label: string; }
export interface NosotrosIdentidadData { eyebrow: string; title: string; paragraphs: string[]; backgroundImageUrl: string; imageUrl: string; tags?: string[]; }
export interface NosotrosValueRow { id: string; title: string; description: string; tags?: string[]; }
export interface NosotrosValuesHeaderData { title: string; intro: string; }
...
export class Nosotros {
  readonly heroData: NosotrosHeroData = {
    ...
    figureImageUrl: '/images/isadecord-nosotros-hero.png',
  ...
  readonly valuesHeader: NosotrosValuesHeaderData = {
    ...
    intro: 'La misión define nuestra razón de ser, la visión nuestra meta y los valores la forma en que trabajamos.',
  };
  ...
  readonly values: NosotrosValueRow[] = [
    {
      id: 'mision',
      title: 'Misión',
      description: 'Ejecutar cada proyecto constructivo y arquitectónico con precisión técnica, cumpliendo los plazos pactados y superando las expectativas de nuestros clientes.',
    },
    {
      id: 'vision',
      title: 'Visión',
      description: 'Ser la constructora de referencia en Ecuador para quienes buscan una obra que combine solidez estructural con un diseño arquitectónico contemporáneo, sin concesiones en ninguna de las dos.',
    },
    {
      id: 'valores',
      title: 'Valores',
